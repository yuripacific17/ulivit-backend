...
from router import admin_router, affiliate_climate_change_impact_router, affiliate_router, calculator_router, climate_measure_router, admin_sku_router
...
app.include_router(admin_sku_router.router)
